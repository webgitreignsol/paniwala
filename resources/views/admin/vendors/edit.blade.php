    	   	...
    	   	<div class="row">
	            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		        	...
		        	<div class="productWrap stockWrap minInput">
						<div class="card-body">
							<form class="contact-form" method="post" action="{{ route('vendors.update', $vendor->id) }}" novalidate="">
								@csrf
								<div class="row">
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		<label>Vendor Name</label>
								    		<input type="text" name="name" id="vendor-name" value="{{ $vendor->name }}" class="form-control">
								  		</div>
									</div>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		<label>Email</label>
								    		<input name="email" type="email" class="form-control" value="{{ $vendor->email }}" required="">
								  		</div>
									</div>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		<label>Mobile</label>
								    		<input type="text" name="phone" class="form-control" value="{{ $vendor->phone }}" data-inputmask="'mask': '0399-99999999'" required=""  type = "number" maxlength = "12" required="">
								  		</div>
									</div>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		...
								    		<input type="number" name="opening_balance" value="{{ $vendor->opening_balance }}" class="form-control">
								  		</div>
									</div>
