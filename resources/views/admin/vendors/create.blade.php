    	   	...
    	   	<div class="row">
	            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		        	...
		        	<div class="productWrap stockWrap minInput">
						<div class="card-body">
							<form class="contact-form" method="post" action="{{ route('vendors.store') }}" novalidate="">
								@csrf
								<div class="row">
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		<label>Vendor Name</label>
								    		<input type="text" name="name" value="{{ old('name') }}" id="vendor-name" class="form-control">
								  		</div>
									</div>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		<label>Mobile</label>
								    		<input type="text" name="phone" class="form-control" value="{{ old('phone') }}" data-inputmask="'mask': '0399-99999999'" required=""  type = "number" maxlength = "12" required="">
								  		</div>
									</div>
									...
									<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
										<div class="input-block">
								    		...
								    		<input type="number" name="opening_balance" value="{{ old('opening_balance') }}" class="form-control">
								  		</div>
									</div>
