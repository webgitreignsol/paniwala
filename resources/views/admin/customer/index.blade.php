						...
						<table id="table-1" class="table table-bordered table-hover advanced-web-table" style="width: 100%; table-layout: fixed;">
					  		<thead class="thead-dark">
							    <tr>
								    ...
								    <th scope="col" style="width: 120px">Area</th>
								    <th scope="col" style="width: 180px">Days</th>
								    <th scope="col" style="width: 120px">Rider</th>
								    <th scope="col" style="width: 120px">Security Deposit</th>
								    <th scope="col" style="width: 120px">Opening Bottle</th>
								    <th scope="col" style="width: 120px">Opening Balance</th>
								    <th scope="col" style="width: 120px">Required Bottle</th>
								    <th scope="col" style="width: 120px">Remarks</th>
					  		...
					  		<tbody>
							    ...
							    <tr>
									...
									<td>{{ $customer->security_deposit }}</td>
									<td>{{ $customer->opening_bottle }}</td>
									<td>{{ $customer->opening_balance }}</td>
									<td>{{ $customer->required_bottle }}</td>
