    	   	...
    	   	<div class="row">
	            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
		        	...
		        	<div class="productWrap stockWrap minInput">
						<div class="card-body">							
							<form class="contact-form" method="post" action="{{ route('products.update', $product->id) }}">
								@csrf
								<div class="card-body">
									<div class="row">
										...
										<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
											<div class="input-block">
						                    	...
						                    	<select class="form-control" name="type" value="{{ $product->type }}" required="">
						                        	...
						                        	<option value="19 ltr Bottle" {{ $product->type == "19 ltr Bottle" ? 'selected="selected"' : '' }}>19 Ltr Bottle</option>
						                        	<option value="Dis bottle" {{ $product->type == "Dis bottle" ? 'selected="selected"' : '' }}>Disposabile Bottle</option>
						                        	<option value="Accessories" {{ $product->type == "Accessories" ? 'selected="selected"' : '' }}>Accessories</option>
						                    	</select>
									  		</div>												
										</div>
									</div>	
