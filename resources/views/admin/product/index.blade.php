						...
						<table id="table-1" class="table table-bordered table-hover advanced-web-table" style="width: 100%; table-layout: fixed;">
					  		...
					  		<tbody>
							    ...
							    <tr>
									...
									<td>{{ $product->type }}</td>
									<td>
										<a href="{{ route('products.edit', $product->id) }}" style="color: green"><i class="far fa-edit"></i></a>
										&nbsp;
										<a href="{{ route('products.destroy', $product->id) }}" onclick="return confirm('Are You Sure You Want to Delete this Product!'); " style="color: red"><i class="far fa-trash-alt"></i></a>
									</td>
							    </tr>
							    @endforeach
					  		</tbody>
