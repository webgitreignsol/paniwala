						...
						<table id="table-1" class="table table-bordered table-hover advanced-web-table" style="width: 100%; table-layout: fixed;">
					  		<thead class="thead-dark">
							    <tr>
								    ...
								    <th scope="col" >Investment Detail</th>
					  		...
					  		<tbody>
							    ...
							    <tr>
									...
									<td>
										<a href="{{ route('investments.edit', $investment->id) }}" style="color: green"><i class="far fa-edit"></i></a>
										&nbsp;
										<a href="{{ route('investments.destroy', $investment->id) }}" onclick="return confirm('Are You Sure You Want to Delete this Record!'); " style="color: red"><i class="far fa-trash-alt"></i></a>
									</td>
							    </tr>
							    @endforeach
					  		</tbody>
