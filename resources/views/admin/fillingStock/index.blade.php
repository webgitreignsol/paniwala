            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            	<div class="stockWrapCont">			            		
        			<div class="addedButtn">
    					<a href="{{ route('fillingStocks.create') }}">Add New Stock</a>
    				</div> 
						...
						<table id="table-1" class="table table-bordered table-hover advanced-web-table" style="width: 100%; table-layout: fixed;">
					  		<thead class="thead-dark">
							    <tr>
								    ...
								    <th scope="col" style="width: 150px">Filling Stock</th>
								    <th scope="col" style="width: 150px">Empty Stock</th>
								    <th scope="col" style="width: 150px">Total Stock</th>
					  		...
					  		<tbody>
							    ...
							    <tr>
									...
									<td>
										<a href="{{ route('fillingStocks.edit', $fillingStock->id) }}" style="color: green"><i class="far fa-edit"></i></a>
										&nbsp;
										<a href="{{ route('fillingStocks.destroy', $fillingStock->id) }}" onclick="return confirm('Are You Sure You Want to Delete this Record!'); " style="color: red"><i class="far fa-trash-alt"></i></a>
									</td>
							    </tr>
							    @endforeach
					  		</tbody>
